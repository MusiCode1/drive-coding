> **בוטל 2026-07-11 — אוחד לתוך `slice-cursor-acp.md`** (יחד עם `cursor`, כי שני ה-briefs נגעו באותם קבצים והחזיקו את אותה שכבת `authenticate`). המסמך הזה נשמר להיסטוריה/מחקר בלבד — אל תעבדי לפיו.
