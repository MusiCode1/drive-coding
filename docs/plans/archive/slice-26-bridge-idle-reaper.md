...
> **‏תאריך**: 2026-06-01
> **‏סטטוס**: ‏הושלם (‏אליעזר, 2026-06-01) — **הוסר ב-slice-remove-idle-reaper (2026-06-16)**
> **Complexity**: 4/10 (verifier: light + phase על Commit 2)
> **‏תלויות (`depends_on`)**: []
> **‏Base**: dev
> **‏Dev tip**: `62b41a0dcdb039bcdd09dba99f97238496f2924b`
>
> ✅ **‏סלייס זמני — הוסר** — תנאי §7 מומש ב-slice-remove-idle-reaper: פאנל active-agents מנהל תהליכים ידנית (future A).
