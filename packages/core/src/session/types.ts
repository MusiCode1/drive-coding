...
export type Patch =
  ...
  | { version: number; op: "append-segment"; targetId: string; segment: SessionSegment; meta?: Record<string, unknown> }
  ...
  | { version: number; op: "update-tool"; targetId: string; toolCall: Partial<SessionToolCall>; meta?: Record<string, unknown> }
  | {
      version: number
      op: "reset"
      messages: SessionMessage[]
