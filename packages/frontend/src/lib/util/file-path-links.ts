 ...
 *
 * 🔴 היקף מכוון: מוחל על טקסט ש**המשתמש** כתב בלבד. שם false-positive הוא
 * לכל היותר 404 על נתיב שהמשתמש עצמו הקליד. לינקיפיקציה של פרוזת-הסוכן היא
 * סלייס נפרד (`path-linkify`), עם מדידת false-positives משלה.
 *
