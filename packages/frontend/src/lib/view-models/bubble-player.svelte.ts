 ...
 * tool bubble → אין ▶. §6 ב-brief.
 *
 * אין $effect — toggle הוא method ישיר (§4.8).
 *
...
export class BubblePlayer {
   ...
   * no-op אם turnState !== "idle" או bubbleId כבר מנגן (לחיצה שנייה → stop).
   */
